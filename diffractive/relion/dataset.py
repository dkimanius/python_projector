...
from diffractive.base.ctf import ContrastTransferFunction
from diffractive.base.particle_dataset import ParticleDataset
from diffractive.base.star_file import load_star
...
class RelionDataset:
    ...
    def load(self, path: str) -> None:
        ...
        self.starfile = starfile.read(self.data_star_path)
    ...
    def make_particle_dataset(
        ...
        dataset.initialize(
            ...
            part_noise_group_id=self.part_noise_group_id[mask],
    ...
    def _load_particles(self, particles: dict) -> None:
        ...
        self.part_random_subset = np.array(self.part_random_subset)
        ...
        self.part_norm_correction = np.array(self.part_norm_correction)
