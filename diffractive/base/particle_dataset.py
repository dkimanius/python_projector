...
from diffractive.base import rescale_real
...
class ParticleDataset(Dataset):
    ...
    def get_output_pixel_size(self, optics_group_index):
        ...
        if self.max_res is None:
            ...
            return self.max_res / 2. if self.max_res / 2 > pixel_size else pixel_size
    ...
    def __getitem__(self, index):
        ...
        data = {
            ...
            "noise_group_idx": self.part_noise_group_idx[index]
        }
        ...
        if self.compute_ctf:
            if not self.has_ctf or self.optics_group_ctfs[og_idx] is None:
                ...
                data["ctf"] = self.optics_group_ctfs[og_idx](
